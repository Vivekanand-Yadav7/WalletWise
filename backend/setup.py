#!/usr/bin/env python3
"""
WalletWise Backend Setup Script
This script helps set up the WalletWise backend application.
"""
...
def create_env_file():
    ...
    db_name = input("Database name (walletwise_dev): ") or "walletwise_dev"
...
def main():
    """Main setup function"""
    print("🚀 Welcome to WalletWise Backend Setup!")
    print("=" * 50)
    ...
    print("\n" + "="*50)
    print("🎉 WalletWise Backend setup completed successfully!")
    print("\n📚 Next steps:")
